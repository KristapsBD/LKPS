...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('parcel.session')->group(function () {
...
Route::middleware("admin")->group(function () {
    ...
    // Route Generation
    Route::get('/admin/generate-route', [AdminController::class, 'viewAllParcels'])->name('admin.generateRouteView');
    Route::post('/admin/generate-route', [GoogleMapsController::class, 'generateOptimizedRoute'])->name('admin.generateRoute');
    ...
    // Bulk Export
    Route::post('/admin/parcels/export-selected', [ExportController::class, 'exportSelectedParcels'])->name('admin.export');
