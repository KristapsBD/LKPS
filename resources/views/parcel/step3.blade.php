    ...
    <div class="container mx-auto p-4 flex flex-col items-center">
        ...
        <form method="POST" action="{{ route('parcel.storeAllData') }}">
            ...
            <section class="mt-4">
                ...
                <div class="mb-4">
                    <label class="block dark:text-white">Name:</label>
                    <span class="dark:text-white">{{ $step2Data ? $step2Data['receiver_name'] : '' }}</span>
                </div>

                <div class="mb-4">
                    <label class="block dark:text-white">Email:</label>
                    <span class="dark:text-white">{{ $step2Data ? $step2Data['receiver_email'] : '' }}</span>
                </div>

                <div class="mb-4">
                    <label class="block dark:text-white">Phone:</label>
                    <span class="dark:text-white">{{ $step2Data ? $step2Data['receiver_phone'] : '' }}</span>
                </div>

                <div class="mb-4">
                    <label class="block dark:text-white">Address:</label>
                    <span class="dark:text-white">{{ $step2Data ? $step2Data['receiver_address'] : '' }}</span>
                </div>
            </section>
