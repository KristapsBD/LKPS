        ...
        <table class="w-full table-auto">
            ...
            @foreach ($parcels as $parcel)
                <tr>
                    ...
                    <td class="border px-4 py-2 dark:text-gray-100">{{ $parcel->sender_user_id }}</td>
                    <td class="border px-4 py-2 dark:text-gray-100">
                        ...
                        <button
                            class="bg-red-500 hover:bg-red-600 text-white font-bold py-1.5 px-4 rounded mr-2 delete-parcel"
                            data-toggle="modal"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-700 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500 dark:text-gray-300">Are you sure you want to delete this parcel?</p>
                    </div>
                </div>
